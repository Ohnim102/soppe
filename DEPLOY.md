...
Plan: Free
Runtime: Node
Build command: npm install --include=dev --include=optional && npm install --workspace frontend --no-save typescript@5.6.3 @types/node@22.20.0 @rollup/rollup-linux-x64-gnu@4.62.2 && npm run build && npm prune --omit=dev
